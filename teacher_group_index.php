            ...
            <table class = "table table-striped table-hover mt-2">
                ...
                <?php foreach ($result as $res) { ?>
                    ...
                    <tr>
                        ...
                        <td><a href="http://localhost/coursework/teacher_edit_student_tasks.php?index=<?php echo $index; ?>&login=<?php echo $res->login; ?>">открыть</a></td>
                    </tr>
